...
var _HLSSource = _interopRequireDefault(require('./HLSSource'));
...
var propTypes = {
  hlsConfig: _propTypes['default'].object,
...
var Video = /*#__PURE__*/ (function(_Component) {
  ...
  function Video(props) {
    ...
    (0, _defineProperty2['default'])(
      ...
      function() {
        return (0, _converters.getEffectiveDuration)(_this.props);
      }
    );
    _this.video = null; // the html5 video
    _this.hlsConfig = _this.play.bind(
      (0, _assertThisInitialized2['default'])(_this)
    );
    ...
    _this.handleProgress = (0, _utils.throttle)(
      _this.handleProgress.bind((0, _assertThisInitialized2['default'])(_this)),
      250
    );
