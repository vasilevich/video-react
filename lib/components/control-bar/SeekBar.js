  ...
  (0, _createClass2['default'])(SeekBar, [
    ...
    },
    {
      ...
      value: function getEffectiveDuration() {
        return (0, _converters.getEffectiveDuration)(this.props);
      }
    },
    {
      key: 'getRealDuration',
      value: function getRealDuration() {
        return (0, _converters.getRealDuration)(this.props);
      }
    },
    {
      key: 'getEffectiveTime',
      value: function getEffectiveTime() {
        return (0, _converters.getEffectiveTime)(this.props);
      }
    },
    {
      key: 'getPercent',
    ...
    {
      key: 'getMarkedTimesPercentages',
      value: function getMarkedTimesPercentages() {
        var _this2 = this;
        var t = this.getMarkedTimes()
          .map(function(time) {
            return (0, _converters.convertToEffectiveTime)(time);
          })
