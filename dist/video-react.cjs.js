...
function mergeAndSortChildren(
  ...
  return children
    ...
    .map(function(element) {
      ...
      var e = /*#__PURE__*/ React__default.cloneElement(
        element,
        props,
...
var Video = /*#__PURE__*/ (function(_Component) {
  ...
  _proto.renderChildren = function renderChildren() {
    ...
    if (props.hlsConfig && props.src) {
      return /*#__PURE__*/ React__default.createElement(HLSSource, {
        isVideoChild: true,
...
var Mark = /*#__PURE__*/ React__default.memo(function(_ref) {
...
var MarkProgressBar$1 = /*#__PURE__*/ React__default.memo(MarkProgressBar);
...
var SeekBar = /*#__PURE__*/ (function(_Component) {
  ...
  _proto.getRealDuration = function getRealDuration$1() {
  ...
  _proto.getMarkedTimesPercentages = function getMarkedTimesPercentages() {
    var _this2 = this;
    var t = this.getMarkedTimes()
      .map(function(time) {
        return convertToEffectiveTime(time);
      })
      .map(function(effectiveTime) {
        return effectiveTime / _this2.getEffectiveDuration();
      });
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/ React__default.createElement(
      ...
      /*#__PURE__*/ React__default.createElement(MarkProgressBar$1, {
...
function TimeDivider(_ref) {
  ...
  return /*#__PURE__*/ React__default.createElement(
    ...
    /*#__PURE__*/ React__default.createElement(
      'div',
      null,
      /*#__PURE__*/ React__default.createElement('span', null, separatorText)
    )
  );
}
...
var ControlBar = /*#__PURE__*/ (function(_Component) {
  ...
  _proto.getDefaultChildren = function getDefaultChildren() {
    return [
      /*#__PURE__*/ React__default.createElement(PlayToggle, {
        key: 'play-toggle',
        order: 1
      }),
...
var Player = /*#__PURE__*/ (function(_Component) {
  ...
  _proto.getDefaultChildren = function getDefaultChildren(originalChildren) {
    ...
    return [
      ...
      /*#__PURE__*/ React__default.createElement(PosterImage, {
        key: 'poster-image',
        order: 1.0
      }),
  ...
  _proto.getChildren = function getChildren(props) {
    ...
    var children = React__default.Children.toArray(this.props.children).filter(
      function(e) {
  ...
  _proto.setWidthOrHeight = function setWidthOrHeight(style, name, value) {
    ...
    Object.assign(
      style,
      ((_Object$assign = {}), (_Object$assign[name] = styleVal), _Object$assign)
    );
  };
  ...
  _proto.startControlsTimer = function startControlsTimer() {
    ...
    React__default.Children.forEach(this.props.children, function(element) {
      if (
        !(/*#__PURE__*/ React__default.isValidElement(element)) ||
    ...
    this.controlsHideTimer = setTimeout(function() {
      _this4.actions.userActivate(false);
